...
@Entity(primaryKeys = {"universityRouteName","name"}, tableName = "trips_table")
public class Trip {
    @NonNull
    private String name;
    ...
    public Trip(@NonNull String universityRouteName, @NonNull String name, @NonNull String src, @NonNull String dest){
        this.universityRouteName = universityRouteName;
        this.name = name;
        this.src = src;
        this.dest = dest;
